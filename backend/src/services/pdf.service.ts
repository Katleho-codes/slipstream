...
export async function generatePayslipPDF(payslip: PayslipWithRelations): Promise<string> {
  ...
  let browser: { newPage: () => Promise<{ setContent: (h: string, o: object) => Promise<void>; pdf: (o: object) => Promise<void> }>; close: () => Promise<void> } | undefined;
  try {
